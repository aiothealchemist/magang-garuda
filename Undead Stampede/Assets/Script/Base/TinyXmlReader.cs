// taken from http://wiki.unity3d.com/index.php?title=TinyXmlReader
...
public class TinyXmlReader
{
	...
	public bool isOpeningTag { get; private set; }
	public string content { get; private set; }

	public TinyXmlReader(string newXml, bool isFile = false)
	{
		xmlString = (isFile ? System.IO.File.ReadAllText(newXml) : newXml);
		//added content
		tagName = ""; content = "";
		isOpeningTag = false;
		idx = 0;
	...
	int IndexOf(char _c, int _i)
	{
		...
		//edited content
		int i;
		for (i = _i; i < xmlString.Length && xmlString[i] != _c; ++i);
		return (i < xmlString.Length ? i : -1);
	}
