...
//	}
	...
	protected override void updateGUI () {
		...
		viewVector = GUI.BeginScrollView (new Rect (width/2, 25, viewWidth, viewHeight), 
		...
		GUI.Box (new Rect (width / 3, height / 4, width / 15, width / 15), objDesc);
